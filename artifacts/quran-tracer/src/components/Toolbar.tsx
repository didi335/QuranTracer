...
export function Toolbar({
  ...
  return (
    ...
    >
      <div className="text-center">
        <h2
          className={`font-bold text-base tracking-wide ${
            isDark ? "text-[#d4af37]" : "text-[#1a5276]"
          }`}
        >
          Quran Tracer
        </h2>
        <p className={`text-xs mt-0.5 ${isDark ? "text-[#a0a0c0]" : "text-[#7f8c8d]"}`}>
          Pen Settings
        </p>
      </div>

      <div>
        <label className={`text-xs font-semibold uppercase tracking-wider mb-2 block ${isDark ? "text-[#a0a0c0]" : "text-[#7f8c8d]"}`}>
          Color
        </label>
          ...
          {PRESET_COLORS.map((c) => (
            <button
              ...
              style={{
                ...
                border:
                  penSettings.color === c
                    ? `3px solid ${isDark ? "#d4af37" : "#1a5276"}`
        ...
        <div className="flex items-center gap-2 mt-2">
          <label className={`text-xs ${isDark ? "text-[#a0a0c0]" : "text-[#7f8c8d]"}`}>
            Custom:
          </label>
          <input
            type="color"
      ...
      <div className="border-t pt-3" style={{ borderColor: isDark ? "#2a2a4e" : "#e8e3d5" }}>
        <label className={`text-xs font-semibold uppercase tracking-wider mb-2 block ${isDark ? "text-[#a0a0c0]" : "text-[#7f8c8d]"}`}>
          Actions
        </label>
        <div className="flex flex-col gap-2">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm font-medium transition-all active:scale-95 ${
              isDark
                ? "bg-[#3a1a1a] text-[#ff9999] hover:bg-[#4a2a2a]"
                : "bg-[#fdecea] text-[#c0392b] hover:bg-[#fbd5d0]"
            }`}
          >
            <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm font-medium transition-all active:scale-95 ${
              isDark
                ? "bg-[#1a3a1a] text-[#90ee90] hover:bg-[#2a4a2a]"
                : "bg-[#eafaf1] text-[#1b7a3e] hover:bg-[#d5f5e3]"
            }`}
          >
            <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
